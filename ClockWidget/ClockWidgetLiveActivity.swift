...
struct ClockWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = ClockWidgetAttributes(name: "Me")
    static let contentState = ClockWidgetAttributes.ContentState(value: 3)
